<div class="nk-header nk-header-fixed is-light">
    <div class="container-fluid">
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none"><a href="{{ route('admin.dashboard') }}" class="logo-link"><img class="logo-light logo-img" src="{{ asset('backend/assets/images/logo.png') }}" srcset="{{ asset('backend/assets/images/logo2x.png 2x') }}" alt="logo"><img class="logo-dark logo-img" src="{{ asset('backend/assets/images/logo-dark.png') }}" srcset="{{ asset('backend/assets/images/logo-dark2x.png 2x') }}" alt="logo-dark"></a></div>
                    ...
                    <li class="dropdown user-dropdown"><a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{ Auth::guard('admin')->user()->role }}</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    <div class="user-info"><span class="lead-text">{{ Auth::guard('admin')->user()->name }}</span><span class="sub-text">{{ Auth::guard('admin')->user()->email }}</span></div>
                                </div>
                            </div>
