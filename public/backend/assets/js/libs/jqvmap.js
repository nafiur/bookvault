...
(JQVMap.prototype = {
    ...
    (JQVMap.prototype.zoomIn = function () {
        ...
        if (l.zoomCurStep < l.zoomMaxStep) {
            (l.transX -=
                (l.width / l.scale - l.width / (l.scale * l.zoomStep)) / 2),
                (l.transY -=
                    (l.height / l.scale - l.height / (l.scale * l.zoomStep)) /
                    2),
    ...
    (JQVMap.prototype.zoomOut = function () {
        ...
        if (l.zoomCurStep > 1) {
            (l.transX +=
                (l.width / (l.scale / l.zoomStep) - l.width / l.scale) / 2),
                (l.transY +=
                    (l.height / (l.scale / l.zoomStep) - l.height / l.scale) /
                    2),
                l.setScale(l.scale / l.zoomStep),
                l.zoomCurStep--;
            var e = jQuery("#zoomSlider");
    ...
    (VectorCanvas.prototype.createGroup = function (l) {
        ...
        return (
            "svg" === this.mode
                ...
                : (((t = this.createVmlNode("group")).style.width =
                      this.width + "px"),
