    ...
    NioApp.Calendar = function () {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function eventClick(info) {
                ...
                !description
                    ? $("#preview-event-description-check").css(
                          "display",
                          "none"
                      )
                    : null;
                ...
                fcMorePopover &&
                    fcMorePopover.forEach(function (elm) {
                        elm.remove();
                    });
        ...
        addEventBtn.on("click", function (e) {
            ...
            var eventStartTimeCheck = eventStartTime
                ? "T" + eventStartTime + "Z"
                : "";
            var eventEndTimeCheck = eventEndTime
                ? "T" + eventEndTime + "Z"
                : "";
            calendar.addEvent({
        ...
        updateEventBtn.on("click", function (e) {
            ...
            var eventEndTimeCheck = eventEndTime
                ? "T" + eventEndTime + "Z"
                : "";
            var selectEvent = calendar.getEventById(
                editEventForm[0].dataset.id
            );
            selectEvent.remove();
            calendar.addEvent({
