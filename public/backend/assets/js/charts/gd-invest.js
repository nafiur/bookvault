        ...
        datasets: [
            {
                ...
                color: "#5d7ce0",
                data: [
                    0, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90,
                    110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90,
                    75, 0,
                ],
            },
        ...
        $elem.each(function () {
            ...
            for (var i = 0; i < _get_data.datasets.length; i++) {
                chart_data.push({
                    label: _get_data.datasets[i].label,
                    tension: 0.4,
                    backgroundColor: NioApp.hexRGB(
                        _get_data.datasets[i].color,
                        0.3
                    ),
                    fill: true,
                    borderWidth: 2,
        ...
        datasets: [
            {
                ...
                //@v2.0
                data: [
                    6000, 8200, 7800, 9500, 5500, 9200, 9690, 6000, 8200, 7800,
                    9500, 5500, 9200, 9690, 6000, 8200, 7800, 9500, 5500, 9200,
                    9690,
                ],
            },
        ],
